...
curl  -XDELETE "http://127.0.0.1:9200/mybooks"
echo
curl  -XPUT "http://127.0.0.1:9200/mybooks" -H 'Content-Type: application/json' -d'
{
  "mappings": {
      "properties": {
        "join_field": {
...
echo
curl   -XPOST "http://127.0.0.1:9200/_bulk?refresh" -H 'Content-Type: application/json' -d'
...
'
echo
curl   -XDELETE "http://127.0.0.1:9200/mybooks-join"

echo
curl   -XPUT "http://127.0.0.1:9200/mybooks-join" -H 'Content-Type: application/json' -d'
{
  "mappings": {
      "properties": {
        "join": {
...
echo
curl   -XPOST "http://127.0.0.1:9200/mybooks-join/_refresh"

echo
curl   -XDELETE 'http://127.0.0.1:9200/mygeo-index'
echo
curl   -XPUT "http://127.0.0.1:9200/mygeo-index" -H 'Content-Type: application/json' -d'
{
  "mappings": {
    "properties": {
      "pin": {
...
echo
curl   -XPUT 'http://127.0.0.1:9200/mygeo-index/_doc/1' -H 'Content-Type: application/json' -d '{"pin": {"location": {"lat": 40.12, "lon": -71.34}}}'
echo
curl   -XPUT 'http://127.0.0.1:9200/mygeo-index/_doc/2' -H 'Content-Type: application/json' -d '{"pin": {"location": {"lat": 40.12, "lon": 71.34}}}'
echo
curl   -XPOST 'http://127.0.0.1:9200/mygeo-index/_refresh'
